...
// Evita a demora de ~1min: em algumas redes o Firestore tenta primeiro uma
// conexão "streaming" que fica tentando antes de cair pro modo alternativo
// (long-polling). Forçando o modo auto-detect logo de cara, ele já escolhe
// o caminho certo sem ficar esperando o modo streaming falhar.
